...
export const shop = [
  ...
  },
  {
    ...
    description:
      'The name jalapeño is Spanish for "from Xalapa", the capital city of Veracruz, Mexico, where the pepper was traditionally cultivated. Jalapeños were in use by the Aztecs prior to the Spanish conquest. The use of peppers in the Americas dates back thousands of years, including the practice of smoking some varieties of peppers in order to preserve them; further well preserved samples and genetic testing would be needed to determine the usage and existence of the jalapeño clade and pod type into the past.',
  },
];
